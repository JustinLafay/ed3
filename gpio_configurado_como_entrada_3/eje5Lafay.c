...
int main(void){
	...
	LPC_GPIO1->FIODIRL &= ~(0b1111111111111111<<0); // input mode from P1.0 to P1.15
	LPC_GPIO0->FIODIR0 |= (0b1111000111111111111<<0); // output mode from
